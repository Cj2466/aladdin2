...
from app.services.stock_analysis.finnhub_fundamentals import FinnhubFundamentalsClient
...
finnhub_fundamentals_client = FinnhubFundamentalsClient()
...
def get_finnhub_fundamentals_client() -> FinnhubFundamentalsClient:
    return finnhub_fundamentals_client
